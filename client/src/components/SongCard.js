            ...
            barRadar
              ? (
                ...
                <ResponsiveContainer height={250}>
                  ...
                  <RadarChart outerRadius={100} width={250} height={250} data={chartData}>
                    <PolarGrid/>
                    <PolarAngleAxis dataKey = 'name'/>
                    <PolarRadiusAxis angle={60} doman = {[0,1]} />
                    <Radar dataKey="value" stroke="#8884d8" fill="#8884d8" fillOpacity={0.8} isAnimationActive = {true} />
                  </RadarChart>
                </ResponsiveContainer>
              )
          }
